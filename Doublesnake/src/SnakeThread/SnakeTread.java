...
public class SnakeTread extends Applet implements KeyListener, Runnable{
	...
	private void drawSnake (Graphics s)
	{
		...
		for(int i = 0; i < this.sLen; i++)
		{
			...
			if(i == 0) s.setColor(Color.black);
			else s.setColor(Color.gray);
	...
	{
		if(snk.dirC.get(i).toString() == "l") snk.dirCode = 1;
		else if(snk.dirC.get(i).toString() == "r") snk.dirCode = 2;
		else if(snk.dirC.get(i).toString() == "u") snk.dirCode = 3;
		else if(snk.dirC.get(i).toString() == "d") snk.dirCode = 4;
	}
	...
	private void drawFood(Graphics f)
	{
		...
		if(this.isF == true) f.fillRect(this.fX, this.fY, this.sW, this.sH);
	...
	{
		if(snk.dir == "l") snk.dirC.add("r");
		else if(snk.dir == "r") snk.dirC.add("l");
		else if(snk.dir == "u") snk.dirC.add("d");
		else if(snk.dir == "d") snk.dirC.add("u");
	}
