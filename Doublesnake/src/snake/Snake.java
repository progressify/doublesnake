...
public class Snake extends JPanel implements ActionListener, Runnable{
    ...
    private final int RAND_POSY = 20;
    ...
    private void imageLoad(Hashtable<String, Image> snake) {
        //PALLINO
        ImageIcon iia = new ImageIcon(this.getClass().getResource(Names.PATH_MELA));
        apple = iia.getImage();
        
        //testa su
        ImageIcon idtsu = new ImageIcon(this.getClass().getResource(Names.PATH_TESTA_SU));
        snake.put("tsu", idtsu.getImage());

        //testa giu
        ImageIcon idtg = new ImageIcon(this.getClass().getResource(Names.PATH_TESTA_GIU));
        snake.put("tg", idtg.getImage());

        //testa destra
        ImageIcon idtd = new ImageIcon(this.getClass().getResource(Names.PATH_TESTA_DESTRA));
        snake.put("td", idtd.getImage());

        //testa sinistra
        ImageIcon idts = new ImageIcon(this.getClass().getResource(Names.PATH_TESTA_SINISTRA));
        snake.put("ts", idts.getImage());

        //coda su 
        ImageIcon idcsu = new ImageIcon(this.getClass().getResource(Names.PATH_CODA_SU));
        snake.put("csu", idcsu.getImage());

        //coda giu
        ImageIcon idcg = new ImageIcon(this.getClass().getResource(Names.PATH_CODA_GIU));
        snake.put("cg", idcg.getImage());

        //coda sinistra
        ImageIcon idcs = new ImageIcon(this.getClass().getResource(Names.PATH_CODA_SINISTRA));
        snake.put("cs", idcs.getImage());

        //coda destra
        ImageIcon idcd = new ImageIcon(this.getClass().getResource(Names.PATH_CODA_DESTRA));
        snake.put("cd", idcd.getImage());

        //verso alto a sinistra
        ImageIcon idaas = new ImageIcon(this.getClass().getResource(Names.PATH_ALTO_ALTO_SINISTRA));
        snake.put("aas", idaas.getImage());

        //verso alto a destra
        ImageIcon idaad = new ImageIcon(this.getClass().getResource(Names.PATH_ALTO_ALTO_DESTRA));
        snake.put("aad", idaad.getImage());

        //verso basso a sinistra
        ImageIcon idabs = new ImageIcon(this.getClass().getResource(Names.PATH_ALTO_BASSO_SINISTRA));
        snake.put("abs", idabs.getImage());

        //verso basso a destra
        ImageIcon idabd = new ImageIcon(this.getClass().getResource(Names.PATH_ALTO_BASSO_DESTRA));
        snake.put("abd", idabd.getImage());

        //corpo orizzontale
        ImageIcon idmo = new ImageIcon(this.getClass().getResource(Names.PATH_MOVIMETNO_ORIZZONTALE));
        snake.put("mo", idmo.getImage());

        //corpo verticale
        ImageIcon idmv = new ImageIcon(this.getClass().getResource(Names.PATH_MOVIMETNO_VERTICALE));
